  ...
  controller.hears([/^MEAL.*$/], 'direct_message,direct_mention', function (bot, message) {
    ...
    console.log()
      ...
      .then((insulinreducerResponse) => {
        ...
        convo.say('ok entered ' + Karbs + ' Kohlenhydrathe and ' + Humalog + ' Einheiten Insulin and you have ' + insulinreducerResponse[0] + ' Einheiten left in your Pen.', function (response, convo) {
          convo.next();
        });
      }).catch(err => {
        console.log(err);
